...
# Zaman serilerinde bir önceki zamandan hareketle işlem yaptığımız için mağazalardaki ürünlerin satışlarını zamana
# göre sıraladık.
...
# shift burada kendini hesaba katmayıp bir önceki değerden basşlayarak ortalama alsın diye kullanıldı.
pd.DataFrame({"sales": df["sales"].values[0:10],
...
# alpha değeri ne kadar 1'e yakınsa bir öncekine daha yakın ortalama değeri gelir.
# Örneğin 11 ile 13'ün ortalaması alpha 0.99 iken ortalama 11.01 gibi bir şey olur. 12 olmaz.
# alpha 0 a yaklaştıkça ortalama 12 ye yaklaşır.13'e değil.
...
# num_boost_round: n_estimators, number of boosting iterations. En az 10000-15000 civarı yapmak lazım.LGBM'nin en önemli hiperparametresi
...
# Üstteki Miuul'a ait, bu ise Microsoft'un LGBM'sinin Feature Importance fonksiyonu
